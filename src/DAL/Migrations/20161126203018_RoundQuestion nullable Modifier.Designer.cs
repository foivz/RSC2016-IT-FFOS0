...
namespace HackathonVZ.Data.Migrations
{
    ...
    [Migration("20161126203018_RoundQuestion nullable Modifier")]
    partial class RoundQuestionnullableModifier
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("HackathonVZ.DAL.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("DAL.Models.Team", b =>
                {
                    b.HasOne("DAL.Models.Image", "Avatar")
                        .WithMany()
            ...
            modelBuilder.Entity("DAL.Models.TeamMember", b =>
                {
                    ...
                    b.HasOne("HackathonVZ.DAL.ApplicationUser", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("DAL.Models.UserProfile", b =>
                {
                    ...
                    b.HasOne("DAL.Models.Lookup.Country", "Country")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.EntityFrameworkCore.IdentityRole", b =>
                {
                    b.HasOne("HackathonVZ.DAL.ApplicationUser")
                        .WithMany("UserRoles")
